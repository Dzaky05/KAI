...
export default function Dashboard() {
  const productionData = [
    { name: "Overhaul Point Machine", progress: 65, icon: <TrainIcon />, color: "#3a7bd5", link: "/overhaul" },
    { name: "Produksi Radio Lokomotif", progress: 82, icon: <AntennaIcon />, color: "#8E2DE2", link: "/produksi" },
    { name: "Produksi Way Station", progress: 45, icon: <FactoryIcon />, color: "#f46b45", link: "/produksi" },
    { name: "Stock Production", progress: 78, icon: <StorageIcon />, color: "#11998e", link: "/stock-production" },
    { name: "Personalia", progress: 92, icon: <PeopleIcon />, color: "#ff416c", link: "/personalia" },
    { name: "Quality Control", progress: 88, icon: <ScienceIcon />, color: "#9C27B0", link: "/quality-control" },
  ];
                    ...
                    <LinearProgress
                      ...
                      sx={{
                        ...
                        '& .MuiLinearProgress-bar': {
                          borderRadius: 5,
                          backgroundColor: item.progress > 75 ? '#4CAF50' : 
            ...
            <ProductionCard>
              <CardContent sx={{ p: 3 }}>
                ...
                <Typography variant="body2" sx={{ 
                  ...
                  Mencapai {productionData.reduce((max, item) => max.progress > item.progress ? max : item).progress}% penyelesaian dengan performa terbaik di antara semua departemen.
                </Typography>
              </CardContent>
            </ProductionCard>
          </Grid>
