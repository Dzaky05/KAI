...
const progressData = [
  { id: 1, title: "Overhaul Point Machine", progress: 65, icon: <OverhaulIcon />, color: "#4CAF50" },
  { id: 2, title: "Stock Production", progress: 78, icon: <StorageIcon />, color: "#2196F3" },
  { id: 3, title: "Ringkasan Produksi", progress: 75, icon: <FactoryIcon />, color: "#FFC107", note: "V2B progress actuals are not actual locations in data collected and cannot detect remote." },
  { id: 4, title: "Produksi Radio Lokomotif", progress: 81, icon: <FactoryIcon />, color: "#9C27B0" },
  { id: 5, title: "Personalia", progress: 92, icon: <PersonaliaIcon />, color: "#FF5722" },
  { id: 6, title: "Products! Way Station", progress: 63, icon: <StorageIcon />, color: "#00BCD4" },
  { id: 7, title: "Quality Control", progress: 81, icon: <QualityIcon />, color: "#795548" },
];

const activityData = [
  {
    id: 1,
    title: "Product Terteggi: Personalis",
    description: "Notebook 90% perspecsation dengan performitoritas.",
  ...
  },
  {
    ...
    description: "500 unit baut baru telah ditambahkan ke inventaris.",
